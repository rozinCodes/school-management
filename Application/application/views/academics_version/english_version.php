                    ...
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="#" class="breadcrumb-link"><?php echo $this->lang->line("english_version"); ?></a></li>
                        ...
                        <div class="row">
                            ...
                            if (isset($allPdt)) {
                                foreach ($allPdt as $value) {
                                      if($value->VERSIONSID==2){
                                    ?>
                                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 ">
                                        <div class="bangla_imag" style="text-align: center">
                                            <a href="<?php echo base_url()."academics_version/english_version/class_book_en?code={$value->ID}" ?>">
