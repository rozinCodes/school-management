...
<div class="dashboard-wrapper">
    <div class="container-fluid  dashboard-content">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <h2><?php echo $this->lang->line("id_card_generate"); ?></h2>
        </div>
            ...
            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form class="needs-validation" novalidate="" action="<?php echo base_url() ?>admin/certificates/generate_id_card" method="post">
     ...
     -->
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form class="needs-validation" novalidate="" action="<?php echo base_url() ?>admin/certificates/generate_id_card/id_card_by_admission_no" method="post">
                                        ...
                                        <thead>
                                            <tr>
                                               <!--  <th><?php //echo $this->lang->line("id"); ?></th> -->
                                                <th scope="col"><?php echo $this->lang->line("f_name"); ?></th>
                                            ...
                                            <tr>
                                               ...
                                               <!-- <td><a class="" href="<?php //echo base_url() ?>admin/student/student_details/details/<?php
                                                ...
                                                <td class="">
                                                    ...
                                                    <a href="<?php echo base_url() ?>admin/certificates/generate_id_card/generate/<?php
                                                   echo $value->STUDENT_ID ?>" class="btn btn-default btn-xs" data-toggle="tooltip" title="" data-original-title="Generate Id Card">
