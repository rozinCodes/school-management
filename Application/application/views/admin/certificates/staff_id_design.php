                            ...
                            <div id="section-to-print">
                                <div class="card-one">
                                    <div class="card-header-one">
                                        ...
                                        <div class="card-img">
                                            <?php if ($pdt->PHOTO) { ?>
                                                <img src="<?php echo base_url(); ?>uploads/staff/picture/<?php echo $pdt->PHOTO ?> " alt="pic"/>
                                                <?php
                                            } else {
                                                ?>
                                    ...
                                    <div class="card-body-one">
                                        ...
                                        foreach($allPdt as $pdt){
                                        ?>
                                        <h4><?php echo $pdt->FIRST_NAME ?> <?php echo $pdt->LAST_NAME ?></h4>
                                        <h5><?php echo $pdt->DESIGNATION_NAME ?></h5>
                                        <hr>
                                        <p>ID: <?php echo $pdt->STAFF_ID ?></p>
                                        <p>JOINING : <?php echo $pdt->DATE_OF_JOINING ?></p>
                                        <p>DATE : <?php echo $pdt->DATE_OF_BIRTH ?></p>
                                        <p>CONTACT: <?php echo $pdt->EMERGENCY_CONTACT ?></p>
                                        <p>GENDER: <?php echo $pdt->GENDER ?></p>
                                           <?php
                                            }
                                            ?>
                                    </div>
