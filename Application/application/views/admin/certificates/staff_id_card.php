            ...
            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form class="needs-validation" novalidate="" action="<?php echo base_url() ?>admin/certificates/design/staff_id_card" method="post">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                ...
                                                <td class="">
                                                    ...
                                                    <a href="<?php echo base_url() ?>admin/certificates/design/staff_id_design/<?php
