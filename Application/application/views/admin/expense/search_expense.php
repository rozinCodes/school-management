<div class="dashboard-wrapper">
    <div class="container-fluid  dashboard-content">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <h2><?php echo $this->lang->line("search_expense"); ?></h2>
        </div>
                    ...
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><?php echo $this->lang->line("search_expense"); ?></li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form class="needs-validation" novalidate action="<?php echo base_url() ?>admin/expense/expense/search_expense" method="post">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td><a href="<?php echo base_url() ?>admin/expense/expense/edit_expense/edit/<?php
                                                    echo $value->ID ?>"><?php echo $this->lang->line("edit"); ?></a></td>
                                                    <td><a href="<?php echo base_url() ?>admin/expense/expense/delete_expense/delete/<?php
