        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="page-header">
                    <h2 class="pageheader-title"><?php echo $this->lang->line("add_asset"); ?> </h2>
                    ...
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><?php echo $this->lang->line("add_asset"); ?></li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <h2 style="color:green"> <?php
                                                    ...
                                                    ?></h2>
                        <form class="needs-validation" novalidate action="<?php echo base_url() ?>admin/assets/asset/add_asset" method="post">
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3 ">
                                    ...
                                    <input type="text" class="form-control" id="validationCustom01" placeholder=" " name="asset_serial" value="" required>
                                ...
                                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3 ">
                                    ...
                                    <input type="text" class="form-control" id="validationCustom01" placeholder=" " name="asset_price" value="" required>
                            ...
                            <div class="row">
                                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3 ">
                                    ...
                                    <input type="date" class="form-control" id="validationCustom01" name="asset_purchase_date">
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3 ">
                                    ...
                                    <input type="text" class="form-control" id="validationCustom01" placeholder="" name="asset_purchase_by" value="" required>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3 ">
                                    ...
                                    <input type="file" class="form-control" id="validationCustom01" placeholder="" name="asset_document" value="" required>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3 ">
                                    ...
                                    <textarea class="form-control" id="validationCustom01" placeholder="" name="asset_description" value="" required></textarea>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                </div>
