...
<div class="dashboard-wrapper">
    <div class="container-fluid  dashboard-content">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <h2><?php echo $this->lang->line("staff_late_attendence"); ?></h2>
        </div>
                    ...
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><?php echo $this->lang->line("staff_late_attendence"); ?></li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form class="needs-validation" novalidate="" action="<?php echo base_url() ?>admin/hrms/staff/staff_late_attendence" method="post">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form class="needs-validation" novalidate="" action="<?php echo base_url() ?>admin/hrms/staff/staff_late_attendence_by_id" method="post">
           ...
           // if(!$_GET['edit']){
            ...
            <!-- end validation form -->
                  ...
                  <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <form class="needs-validation" novalidate="" action="<?php echo base_url() ?>admin/hrms/staff/staff_late_attendence_submit" method="post">
                                               ...
                                               <td><?php echo $value->FIRST_NAME?></td>
                                                ...
                                                <td>
                                                    ...
                                                    <div>
                                                        ...
                                                        <label>
                                                            <input type="radio" name="attendance[<?php echo $value->STAFF_ID?>]" id="option1" value="LATE" >  LATE
                                                        </label>
                                                        &emsp;
