                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                   ...
                                                   ?>
                                                     ...
                                                     <td><button class="btn btn-info" onclick="myBtn('<?php echo $i++; ?>','<?php echo $value->ID ?>','<?php echo $value->STAFF_ID ?>','<?php echo $value->LEAVE_TYPE_ID ?>','<?php echo $value->LEAVE_NAME?>','<?php echo $value->LEAVE_FROM ?>','<?php echo $value->LEAVE_TO?>','<?php echo $value->LEAVE_DAYS?>','<?php echo $value->APPLIED_DATE?>','<?php echo $value->FIRST_NAME?>')"><i class="fas fa-align-justify"></i></button></td> 
                ...
                <h3  class="border-bottom" style="text-align: center;">Details</h3>
                 ...
                 <div id="section-to-print" class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
                        ...
                        <input type="text" class="form-control" name="apply_date"  id="apply_date" required="">
