...
<div class="dashboard-wrapper">
    <div class="container-fluid  dashboard-content">
        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="page-header">
                    <h2 class="pageheader-title"><?php echo $this->lang->line("add_income"); ?> </h2>
                    ...
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><?php echo $this->lang->line("add_income"); ?></li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    <h5 class="card-header"><?php echo $this->lang->line("add_income"); ?></h5>
                    ...
                    <div class="card-body">
                        ...
                        ?></h2>
                        <form enctype="multipart/form-data" class="needs-validation" novalidate action="<?php echo base_url() ?>admin/income/income/add_income" method="post">
                            <div class="row">
                                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3 ">

                                    <label for="validationCustom01"><?php echo $this->lang->line("income_category"); ?></label>
                                    <select  class="form-control" name="income_category" id="validationCustom01" required>
                                ...
                                <input type="text" class="form-control" id="validationCustom01" placeholder=" " name="income_name" value="" required>
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-3 ">
                                ...
                                <input type="date"  class="form-control" id="validationCustom01" name="income_purchase_date" required>
                                <div class="valid-feedback">
                                    Looks good!
                                </div>
                            </div>
