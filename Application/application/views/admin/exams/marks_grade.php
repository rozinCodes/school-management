            ...
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form class="needs-validation" novalidate action="<?php echo base_url() ?>admin/exams/marksgrade/edit_marksgrade/edit/<?php
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6 ">
                                    ...
                                    <input type="text" class="form-control" id="validationCustom01" placeholder=" " name="grade_name" value="<?php echo $value->GRADE_NAME; ?>" required>
                                    ...
                                    <input type="text" class="form-control" id="validationCustom01" placeholder="" name="percent_from" value="<?php echo $value->PERCENT_FROM; ?>" required>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                    ...
                                    <input type="text" class="form-control" id="validationCustom01" placeholder="" name="percent_upto" value="<?php echo $value->PERCENT_UPTO; ?>" required>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                    ...
                                    <input type="text" class="form-control" id="validationCustom01" placeholder="" name="grade_point" value="<?php echo $value->GRADE_POINT; ?>" required>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <h2 style="color:green"> <?php
                            ...
                            ?></h2>
                        <form class="needs-validation" novalidate action="<?php echo base_url() ?>Admin/exams/Marksgrade/insert" method="post">
                            <div class="row">
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6 ">
                                    ...
                                    <table class="table table-striped table-bordered first">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="<?php echo base_url()?>admin/exams/marksgrade/edit_marksgrade/edit/<?php
                                                   echo $value->ID ?>"><?php echo $this->lang->line("edit"); ?></a></td>


                                                <td><a href="<?php echo base_url() ?>Admin/exams/marksgrade/delete_marksgrade/delete/<?php
