                    ...
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="#" class="breadcrumb-link"><?php echo $this->lang->line("student_info"); ?></a>
                                </li>
                                <li class="breadcrumb-item active" aria-current="page">
                                    <?php echo $this->lang->line("student_attendence"); ?></li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form class="needs-validation" novalidate="" action="<?php echo base_url() ?>studentAttendence" method="post">
                            ...
                            <div class="row">
                                <div class="col-xl-12 col-lg-12  col-md-12 col-sm-12 col-12 ">
                                    <button class="btn btn-primary my_btn_style pull-right" type="submit">Search</button>
                                </div>
                            </div>
     ...
     -->
        ...
        <div class="row">
            ...
            ?>
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <h5 class="card-header"><?php echo $this->lang->line("sections") . " " . $this->lang->line("edit"); ?>
                                </h5>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="card">
                    ...
                    <form class="needs-validation" novalidate="" action="<?php echo base_url() ?>admin/student/save_student_attendence" method="post">
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md- col-sm-4 col-4>
                                ...
                                <?php echo $this->lang->line("staff_id"); ?></label>
                                <input type="text" class="form-control" id="validationCustom01" placeholder=" Enter Staff Id " name="staff_id" value="<?php echo $get_staff->STAFF_ID ?>" required readonly>
                                <div class="valid-feedback">
                                    Looks good!
                                </div>
                            </div>
                                ...
                                <table class="table ">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                    ...
                                                    <td>
                                                        ...
                                                        if ($wickend == "Friday") { ?>
                                                            ...
                                                            <div>
                                                                ...
                                                                <label>
                                                                    <input type="radio" name="attendance[<?php echo $value->ADMISSION_NO;echo $value->STUDENT_ID ?>]" id="option1" value="WICKEND" checked> Wickend
                                                                    <!-- <input type="radio" name="attendance2[<?php echo $value->STUDENT_ID ?>]" id="option1" value="WICKEND" checked> Wickend -->
                                                                </label>
                                                        ...
                                                        <?php
                                                            ...
                                                            <div>
                                                                ...
                                                                <label>
                                                                    <input type="radio" name="attendance[<?php echo $value->ADMISSION_NO; echo"/";echo $value->STUDENT_ID ?>]" id="option1" value="PRESENT" checked> Present
                                                                
                                                                </label>
                                                                &emsp;
                                                                <label>
                                                                    <input type="radio" name="attendance[<?php echo $value->ADMISSION_NO;echo"/";echo $value->STUDENT_ID ?>]" value="ABSENT" id="option1">Absent
                                                                    <!-- <input type="radio" name="attendance2[<?php echo $value->STUDENT_ID ?>]" value="ABSENT" id="option1">Absent -->
                                                                </label>
                                                        ...
                                                        <input type="hidden" name="admission_session" value="<?php echo $value->ADMISSION_SESSION ?>">
                                                    </td>
                                            ...
                                            <td> <button class="btn btn-primary my_btn_style" type="submit">Submit Attendence</button></td>
                                        <?php
                                            $i++;
