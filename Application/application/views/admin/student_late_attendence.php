...
<div class="dashboard-wrapper">
    <div class="container-fluid  dashboard-content">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <h2><?php echo $this->lang->line("student_late_attendence"); ?></h2>
        </div>
                    ...
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><?php echo $this->lang->line("student_late_attendence"); ?></li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form class="needs-validation" novalidate="" action="<?php echo base_url() ?>admin/student/student_late_attendence" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md- col-sm-4 col-4">
                                    ...
                                    <input type="text" class="form-control" id="validationCustom01" placeholder="" name="staff_id" value="<?php echo $get_staff->STAFF_ID?>" required readonly>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                            </div>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md- col-sm-4 col-4">
                                    <label for="validationCustom01"><?php echo $this->lang->line("date"); ?></label>
                                    <br>
                                    <input class="form-control" id="validationCustom01" type="date" name="atnd_date" required>
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                    <br>
 ...
 -->
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form class="needs-validation" novalidate="" action="<?php echo base_url() ?>admin/student/student_late_attendence_by_admission_no" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
                                ...
                                <input type="text" class="form-control" id="validationCustom01" placeholder=" Enter Staff Id " name="staff_id" value="<?php echo $get_staff->STAFF_ID?>" placeholder="<?php echo $get_staff->STAFF_ID?>" required readonly>
                                <div class="valid-feedback">
                                    Looks good!
                                </div>
                            </div>
           ...
           // if(!$_GET['edit']){
            ...
            <!-- end validation form -->
                  ...
                  <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <form class="needs-validation" novalidate="" action="<?php echo base_url() ?>admin/student/student_late_attendence_submit" method="post">

                            <div class="card-body">
                                
                                <div class="row">
                                    <div class="col-xl-4 col-lg-4 col-md- col-sm-4 col-4 pull-right">
                                        <label for="validationCustom01"><?php echo $this->lang->line("staff_id"); ?></label>
                                        <input type="text" class="form-control" id="validationCustom01" placeholder="" name="staff_id" value="<?php echo $get_staff->STAFF_ID?>" required readonly>
                                        <div class="valid-feedback">
                                            Looks good!
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                               ...
                                               <td><?php echo $value->ROLL_NO?></td>
                                                ...
                                                <td>
                                                    <!-- <input type="checkbox" id="attendence" name="attendence[]" value="<?php //echo $value->ADMISSION_NO?>" >
                                                    <label for="attendence">Absent</label><br> -->
                                                    ...
                                                    <div>
                                                        ...
                                                        <label>
                                                            <input type="radio" name="attendance[<?php echo $value->ADMISSION_NO?>]" value="LATE" id="option1"> Late
                                                        </label>
                                ...
                                <br>
                                <button class="btn btn-primary my_btn_style" type="submit">Update Attendence</button>
                            </div>
                        </form>    
                        </div>
                    </div>
