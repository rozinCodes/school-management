...
<div class="dashboard-wrapper">
    <div class="container-fluid  dashboard-content">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <h2><?php echo $this->lang->line("alumni_report"); ?></h2>
        </div>
                    ...
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="#" class="breadcrumb-link"><?php echo $this->lang->line("alumni"); ?></a></li>
                                <li class="breadcrumb-item active" aria-current="page"><?php echo $this->lang->line("alumni_report"); ?></li>
                            </ol>
                        </nav>
                    </div>
                </div>
            ...
            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 col-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form class="needs-validation" novalidate="" action="<?php echo base_url() ?>admin/alumni/alumni_report/report" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-lg-3  col-md-3 col-sm-3 col-3 ">
                                        ...
                                        <select class="form-control" id="sesstion_id" name="session"  required="">
                                                    <option value="" selected>Select</option>
                                                    <?php 
                                                    if(isset($allPdt4)){
     ...
     -->
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form class="needs-validation" novalidate="" action="<?php echo base_url() ?>admin/alumni/alumni_report/alumi_student_list_by_admission_no" method="post">
                                            ...
                                            <tr>
                                               ...
                                               <!-- <td><a class="" href="<?php //echo base_url() ?>admin/student/student_details/details/<?php
                                                ...
                                                <td class="">
                                                    ...
                                                    <a href="<?php echo base_url() ?>admin/student/student_details/details/<?php
