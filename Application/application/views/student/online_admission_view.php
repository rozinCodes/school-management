                                        ...
                                        <thead>
                                            <tr>
                                               <!--  <th><?php //echo $this->lang->line("id"); ?></th> -->
                                                ...
                                                <th scope="col"><?php echo $this->lang->line("l_name"); ?></th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                               <!--  <td><?php //echo $value->ID?></td> -->
                                                ...
                                                <td><a target="_blank" class="std_list_color" href=""><?php echo $value->F_NAME?></a></td> 
                                                <td><?php echo $value->L_NAME?></td>
                                                <td><?php echo $value->GENDER?></td>
                                                <td><?php echo $value->CLASSES?></td>
                                                <td><?php echo $value->MOBILE_NO?></td> 
                                                <td><?php echo $value->DATE_OF_BIRTH?></td> 
                                                <td><?php echo $value->EMERGENCY_CONTACT?></td> 
                                                <td><?php echo $value->ADMISSION_DATE?></td> 

                                                   

                                           <td><?php echo $value->ADMISSION_STATUS?></td> 

                                                 <td><a href="<?php echo base_url()."student/online_admission/edit/{$value->ID}"?>" class="btn btn-info">Action</a></td>   
